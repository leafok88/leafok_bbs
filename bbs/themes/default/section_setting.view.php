...
<?
		...
		{
?>
						<option value="<? echo $section["sid"]; ?>" <? echo ($section["sid"] == $result_set["data"]["sid"] ? "selected" : ""); ?>>&nbsp;&nbsp;├<? echo $section["title"]; ?></option>
<?
		}
	}
?>
...
?>
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="ex_update" <? echo ($result_set["data"]["ex_update"] ? "checked" : ""); ?>>申请更新
				</td>
			</tr>
			<tr>
				<td align="right">
