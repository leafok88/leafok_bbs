<?php
	...
	$sql = "SELECT SID FROM bbs WHERE AID = $id AND TID = 0 AND visible";
	...
	if ($set)
	{
		$sql = "INSERT IGNORE INTO article_favorite(UID, AID) VALUES(" .
				$_SESSION["BBS_uid"] . ", $id)";
	}
	else
	{
		$sql = "DELETE FROM article_favorite WHERE UID = " . $_SESSION["BBS_uid"] .
				" AND AID = $id";
	}
	...
	{
		$result_set["return"]["code"] = -2;
		$result_set["return"]["message"] = "Set favorite error: " . mysqli_error($db_conn);
