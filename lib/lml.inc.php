...
function FB2LML(string $str) : string
{
	...
	$patterns = array(
		"/\033\[([01]?;)*([0-9]{2};)?30m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?31m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?32m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?33m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?34m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?35m(;[0-9]{2})?/",
		"/\033\[([01]?;)*([0-9]{2};)?36m(;[0-9]{2})?/",
